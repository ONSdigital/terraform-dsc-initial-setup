...
| Name | Description |
|------|-------------|
| <a name="output_tf-buckets-names"></a> [tf-buckets-names](#output\_tf-buckets-names) | Map of bucket suffixes to bucket names. For example: { state = <bucket\_name>, logs = <bucket\_name>, ... } |
